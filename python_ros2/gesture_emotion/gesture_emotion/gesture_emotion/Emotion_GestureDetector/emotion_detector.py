...
class EmotionDetector:
    ...
    def __init__(
        ...
        # --- INÍCIO DA CORREÇÃO ---
        # Descobre o caminho absoluto para a pasta onde este script está
        ...
        # --- INÍCIO DA CORREÇÃO ---
        # Constrói o caminho absoluto para o modelo de emoção
        emotion_model_path = os.path.join(self.script_dir, "models", model_name)
        self.emotion_model = self.load_trained_model(
            emotion_model_path, # Usa o caminho absoluto
    ...
    # Versão CORRIGIDA da função load_face_model
    def load_face_model(self, backend_option: int) -> cv2.dnn_Net:
        """
        Load the face model for face detection.
        """
        # --- INÍCIO DA CORREÇÃO ---
        # Constrói o caminho absoluto para os arquivos do modelo de face
        prototxt_path = os.path.join(self.script_dir, "models", "face_detector", "res10_300x300_ssd_iter_140000.prototxt")
        caffemodel_path = os.path.join(self.script_dir, "models", "face_detector", "res10_300x300_ssd_iter_140000.caffemodel")
