...
obj.pCAD.obj{1} = loadawobj('Pioneer3DXAssembly(old).obj');
obj.pCAD.mtl{1} = loadawmtl('Pioneer3DXAssembly(old).mtl');

% obj.pCAD.obj{1} = loadawobj('Pioneer3DXAssembly_maisLeve.obj');
% obj.pCAD.mtl{1} = loadawmtl('Pioneer3DXAssembly_maisLeve.mtl');
...
obj.pCAD.obj{1}.v(1,:) = obj.pCAD.obj{1}.v(1,:) - 0.09*ones(1,length(obj.pCAD.obj{1}.v(1,:)));
...
% obj.pCAD.obj{2} = loadawobj('trailerNEROcolored.obj');
% obj.pCAD.mtl{2} = loadawmtl('trailerNEROcolored.mtl');
