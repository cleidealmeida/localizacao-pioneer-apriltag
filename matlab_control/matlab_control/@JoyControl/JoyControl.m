                ...
                switch type(1)
                    ...
                    case {'A','a'}
                        ...
                        if sum(abs(obj.pAnalog)) > 0
                            % Joystick Control signals
                            temp  = obj.pAnalog'.*[1 -1 -1 1 1]';
                            robot.pSC.Ud = [temp(4); temp(5); temp(2); temp(3)].*[0.5; 0.5; 0.2; 0.5];
                        end
                    ...
                    case {'B','b'}
                        ...
                        if sum(abs(obj.pAnalog)) > 0.05
                            % Joystick Control signals
                            temp  = obj.pAnalog'.*[1 -1 -1 -1 -1]';
                            robot.pSC.Ud = [temp(5); temp(4); temp(2); temp(3)];
                        else
                            if sum(abs(robot.pSC.Ud)) < 0.05
                                robot.pSC.Ud = [0; 0; 0; 0];
                            end
